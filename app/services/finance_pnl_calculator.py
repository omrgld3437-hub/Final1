...
from app.db.models import TradeNormalized, PnlRealized
...
class FinancePnlCalculator:
    ...
    def calculate_unrealized_pnl(self, account_id: int) -> Dict:
        ...
        return {"unrealized_pnl": unrealized_pnl, "positions": positions}
