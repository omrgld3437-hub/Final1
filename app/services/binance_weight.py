...
def record_weight_used(account_id: Optional[int], api_key: Optional[str], weight: int, latency_ms: float = 0) -> None:
...
def get_weight_used_last_60s(account_id: Optional[int] = None, api_key: Optional[str] = None) -> int:
...
def get_weight_denied_count(account_id: Optional[int] = None, api_key: Optional[str] = None) -> int:
    return _weight_denied_count.get(_key(account_id, api_key), 0)


def get_weight_wait_ms(account_id: Optional[int] = None, api_key: Optional[str] = None) -> float:
