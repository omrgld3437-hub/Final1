...
# omeraltinhtml (8080) — Linux'ta klasor adi Omeraltinhtml (buyuk O) olabilir; ikisini de dene
HTML_PID=""
HTML_DIR=""
for d in "omeraltinhtml" "Omeraltinhtml"; do
...
elif [ -d "$ROOT/omeraltinhtml" ] || [ -d "$ROOT/Omeraltinhtml" ]; then
  HTML_DIR="$ROOT/omeraltinhtml"
