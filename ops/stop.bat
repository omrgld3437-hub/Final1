...
set "LOCKDIR=%ROOT%marketing"
if not exist "!LOCKDIR!" set "LOCKDIR=%ROOT%Omeraltinhtml"
if exist "!LOCKDIR!" (
  echo. 2> "!LOCKDIR!\.lockcheck" 2>nul
  if errorlevel 1 (
    echo [UYARI] marketing klasoru kilitli olabilir. Explorer penceresini kapatip tekrar deneyin.
  ) else (
