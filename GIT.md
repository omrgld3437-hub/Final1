...
> HEAD `7c0a013` · Toplam **103** commit · branch `main`
...
| Aktif branch | `main` |
| HEAD (kısa) | `7c0a013` |
| HEAD (tam) | `7c0a013d3a61760e241b4af72cd662bcb2bac7f1` |
...
### 1. `7c0a013` — WIP: dynamic mode, param assistant, dashboard/UI updates (pre dip-fiyat fix)
...
### 2. `6692270` — docs: sync GIT.md (git log)
...
### 3. `1791a18` — Fix Binance whitelist connectivity alerts
...
### 4. `958c3b8` — docs: sync GIT.md (git log)
...
### 5. `af1ba2e` — Update dashboard assistant and bot safety handling
...
### 6. `0628f1a` — docs: sync GIT.md (git log)
...
### 7. `f8e66f4` — Fix CI by applying ruff format to changed Python files.
...
### 8. `cf13584` — docs: sync GIT.md (git log)
...
### 9. `bca4d29` — Add dynamic mode, bot alpha performance, and dashboard UX improvements.
...
### 10. `4a6ab47` — test: use portable pytest database path
...
### 11. `1ab5047` — ci: expose pytest failure details
...
### 12. `5864bcc` — ci: pin pytest for stable actions run
...
### 13. `b15e563` — docs: sync GIT.md (git log)
...
### 14. `796a807` — ci: stabilize github actions quality job
...
### 15. `e4bbdda` — docs: sync GIT.md (git log)
...
### 16. `d7e5bfa` — fix(test): test_parallel_grids max_buy_levels=2 eksikti
...
### 17. `a8543b2` — docs: sync GIT.md (git log)
...
### 18. `cf12ad3` — ci: ruff lint+format hatalarını düzelt, ruff.toml ekle
...
### 19. `c6d5f3a` — docs: sync GIT.md (git log)
...
### 20. `cfdec7a` — fix: bot detay start logları gizlenme hatası düzeltildi
...
### 21. `c008064` — docs: sync GIT.md (git log)
...
### 22. `e7c4678` — fix: user stream yeniden başlatma sonrası hatalı ERROR seviyesi giderildi
...
### 23. `63078d8` — docs: sync GIT.md (git log)
...
### 24. `409c88a` — fix: user stream HTML yanıt tespiti — ağ engeli ile API hatası ayırt edildi
...
### 25. `da9761f` — docs: sync GIT.md (git log)
...
### 26. `ad0df7d` — feat: kapsamlı UI/UX ve backend iyileştirmeleri
...
### 27. `a6d07e3` — docs: sync GIT.md (git log)
...
### 28. `11173e6` — Display enriched CYCLE_END/START fields in bot engine log UI
...
### 29. `223cfb3` — docs: sync GIT.md (git log)
...
### 30. `abca2df` — Enrich CYCLE_END/START events: duration, grid utilization, price range, breakeven, cumulative PnL
...
### 31. `637e93f` — docs: sync GIT.md (git log)
...
### 32. `b6cd00c` — Production hardening and bot health fixes
...
### 33. `59fbd9a` — docs: sync GIT.md (git log)
...
### 34. `95a498b` — Fix USER_STREAM 410 Gone: auto-reconnect + account label in logs
...
### 35. `d140169` — docs: sync GIT.md (git log)
...
### 36. `350bbdb` — Modularize dashboard.js phase 3: bot-perf, tx-history, bots, create-modal, tabs
...
### 37. `791ca71` — docs: sync GIT.md (git log)
...
### 38. `ccad8be` — Modularize dashboard.js phase 2: appbar, wallet-state, spot-trade, finance
...
### 39. `5c8dcee` — docs: sync GIT.md (git log)
...
### 40. `b9a042f` — Modularize dashboard.js: extract format utils + leaderboard (phase 1)
...
### 41. `e2d8fba` — docs: sync GIT.md (git log)
...
### 42. `2c6479f` — Implement CTO report items: CORS, admin security, daily loss limit, health endpoints
...
### 43. `98e58e9` — docs: sync GIT.md (git log)
...
### 44. `c05cad8` — Fix BINANCE_UNREACHABLE false-positive: suppress transient outage alerts & faster recovery
...
### 45. `c4aecf7` — docs: sync GIT.md (git log)
...
### 46. `f0b7446` — Fix wallet stale flicker, bot yellow mislead, ETH synthetic balance & cycle ledger fee bug
...
### 47. `ec8e100` — docs: sync GIT.md (git log)
...
### 48. `dabab68` — Speed up finance history first paint
...
### 49. `310fb3c` — docs: sync GIT.md (git log)
...
### 50. `1b1dc05` — Add bounded log maintenance and reduce runtime noise
...
### 51. `285d08e` — docs: sync GIT.md (git log)
...
### 52. `40264fc` — Stabilize dashboard runtime and UI state
...
### 53. `53479f6` — docs: sync GIT.md (git log)
...
### 54. `e060cae` — Improve admin, dashboard, and bot detail UX with perf and scroll fixes.
...
### 55. `f0519b1` — docs: sync GIT.md (git log)
...
### 56. `dfd42cc` — Expand login page with zip welcome layout and market dock.
...
### 57. `3f93c07` — docs: sync GIT.md (git log)
...
### 58. `44f08d8` — Redesign login page with zip AuthCard glass theme.
...
### 59. `c69193c` — docs: sync GIT.md (git log)
...
### 60. `5a99e35` — Fix Binance wallet errors, dashboard UX, and engine log stability.
...
### 61. `95318b1` — docs: sync GIT.md (git log)
...
### 62. `1e03319` — Fix dashboard connectivity, rate-limit toasts, and bot UX regressions.
...
### 63. `99aeb83` — docs: sync GIT.md (git log)
...
### 64. `e17f1da` — UI: redesign admin header/KPI/tabs and improve dashboard Bots persistence.
...
### 65. `4b8b710` — docs: sync GIT.md with Bots tab and wallet UX commit details.
...
### 66. `3f64a0a` — docs: sync GIT.md (git log)
...
### 67. `a8280fd` — Restore dashboard Bots tab and improve wallet/manager spot UX.
...
### 68. `a30acfa` — docs: sync GIT.md (git log)
...
### 69. `42444b9` — Perf: batch live API, bulk state loads, and calmer UI polling.
...
### 70. `5dc6e2c` — docs: sync GIT.md (git log)
...
### 71. `4857932` — UI stability, manager metrics, and test-account worker hardening.
...
### 72. `71e8888` — docs: sync GIT.md (git log)
...
### 73. `13b5770` — Improve test paper trading realism and align test KPIs across admin and dashboard.
...
### 74. `b2ab64c` — docs: sync GIT.md (git log)
...
### 75. `329f600` — Align admin active bot count and reduce Binance/asyncio log noise.
...
### 76. `385d3e9` — docs: sync GIT.md (git log)
...
### 77. `2a7894d` — Fix test account wallet KPI/strip and harden upstream error handling.
...
### 78. `7271b17` — docs: sync GIT.md (git log)
...
### 79. `dc69f29` — docs: sync GIT.md (git log)
...
### 80. `9ec9b4f` — Fix bot state hero panel live updates and duration ticker.
...
### 81. `eda020a` — docs: sync GIT.md (git log)
...
### 82. `419defa` — docs: sync GIT.md (git log)
...
### 83. `a09249b` — Fix manager global restart UnboundLocalError causing HTTP 500.
...
### 84. `19eea96` — docs: sync GIT.md (git log)
...
### 85. `1a87f0f` — docs: sync GIT.md (git log)
...
### 86. `5f6c321` — docs: sync GIT.md (git log)
...
### 87. `80e39e9` — Bot UI/engine reliability: daily K/Z, cycle timer, logs, and manager global actions.
...
### 88. `4245e01` — docs: sync GIT.md (git log)
...
### 89. `1db1ee5` — docs: sync GIT.md (git log)
...
### 90. `c2c6cae` — docs: sync GIT.md (git log)
...
### 91. `9987ecb` — docs: sync GIT.md (git log)
...
### 92. `379bb3c` — Bot session tenure, connectivity restore, synthetic cycle logs, and wallet KPI alignment.
...
### 93. `2498bb1` — Dashboard, manager, and engine hardening across bot perf, leaderboard, and ops.
...
### 94. `7756f7c` — docs: sync GIT.md (git log)
...
### 95. `5a163ba` — Bot health resilience, grid/profit UI polish, and engine hardening.
...
### 96. `9634309` — docs: sync GIT.md (git log)
...
### 97. `3531540` — Grid trailing, Binance connectivity, and dashboard KPI hardening.
...
### 98. `5481c74` — docs: sync GIT.md (git log)
...
### 99. `1974512` — Add grid trade modal, manager log UX, and bot detail sync fixes.
...
### 100. `1cd3a5e` — Update marketing submodule to latest landing and deploy changes.
...
### 101. `805594b` — Engine log UX, health alerts, grid trailing hardening, and tur trade fixes.
...
### 102. `4ba8f8c` — Checkpoint: pre profit-exit trigger fix (REST SSOT, UI, ops reorg).
...
### 103. `8c5aa65` — chore: history — 2026-05-06 öncesi tüm commitler squash edildi
