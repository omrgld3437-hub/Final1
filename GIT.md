...
> HEAD `1791a18` · Toplam **101** commit · branch `main`
...
| Aktif branch | `main` |
| HEAD (kısa) | `1791a18` |
| HEAD (tam) | `1791a187e1ef9315a692d6cee621fd2a35406a82` |
...
### 1. `1791a18` — Fix Binance whitelist connectivity alerts
...
### 2. `958c3b8` — docs: sync GIT.md (git log)
...
### 3. `af1ba2e` — Update dashboard assistant and bot safety handling
...
### 4. `0628f1a` — docs: sync GIT.md (git log)
...
### 5. `f8e66f4` — Fix CI by applying ruff format to changed Python files.
...
### 6. `cf13584` — docs: sync GIT.md (git log)
...
### 7. `bca4d29` — Add dynamic mode, bot alpha performance, and dashboard UX improvements.
...
### 8. `4a6ab47` — test: use portable pytest database path
...
### 9. `1ab5047` — ci: expose pytest failure details
...
### 10. `5864bcc` — ci: pin pytest for stable actions run
...
### 11. `b15e563` — docs: sync GIT.md (git log)
...
### 12. `796a807` — ci: stabilize github actions quality job
...
### 13. `e4bbdda` — docs: sync GIT.md (git log)
...
### 14. `d7e5bfa` — fix(test): test_parallel_grids max_buy_levels=2 eksikti
...
### 15. `a8543b2` — docs: sync GIT.md (git log)
...
### 16. `cf12ad3` — ci: ruff lint+format hatalarını düzelt, ruff.toml ekle
...
### 17. `c6d5f3a` — docs: sync GIT.md (git log)
...
### 18. `cfdec7a` — fix: bot detay start logları gizlenme hatası düzeltildi
...
### 19. `c008064` — docs: sync GIT.md (git log)
...
### 20. `e7c4678` — fix: user stream yeniden başlatma sonrası hatalı ERROR seviyesi giderildi
...
### 21. `63078d8` — docs: sync GIT.md (git log)
...
### 22. `409c88a` — fix: user stream HTML yanıt tespiti — ağ engeli ile API hatası ayırt edildi
...
### 23. `da9761f` — docs: sync GIT.md (git log)
...
### 24. `ad0df7d` — feat: kapsamlı UI/UX ve backend iyileştirmeleri
...
### 25. `a6d07e3` — docs: sync GIT.md (git log)
...
### 26. `11173e6` — Display enriched CYCLE_END/START fields in bot engine log UI
...
### 27. `223cfb3` — docs: sync GIT.md (git log)
...
### 28. `abca2df` — Enrich CYCLE_END/START events: duration, grid utilization, price range, breakeven, cumulative PnL
...
### 29. `637e93f` — docs: sync GIT.md (git log)
...
### 30. `b6cd00c` — Production hardening and bot health fixes
...
### 31. `59fbd9a` — docs: sync GIT.md (git log)
...
### 32. `95a498b` — Fix USER_STREAM 410 Gone: auto-reconnect + account label in logs
...
### 33. `d140169` — docs: sync GIT.md (git log)
...
### 34. `350bbdb` — Modularize dashboard.js phase 3: bot-perf, tx-history, bots, create-modal, tabs
...
### 35. `791ca71` — docs: sync GIT.md (git log)
...
### 36. `ccad8be` — Modularize dashboard.js phase 2: appbar, wallet-state, spot-trade, finance
...
### 37. `5c8dcee` — docs: sync GIT.md (git log)
...
### 38. `b9a042f` — Modularize dashboard.js: extract format utils + leaderboard (phase 1)
...
### 39. `e2d8fba` — docs: sync GIT.md (git log)
...
### 40. `2c6479f` — Implement CTO report items: CORS, admin security, daily loss limit, health endpoints
...
### 41. `98e58e9` — docs: sync GIT.md (git log)
...
### 42. `c05cad8` — Fix BINANCE_UNREACHABLE false-positive: suppress transient outage alerts & faster recovery
...
### 43. `c4aecf7` — docs: sync GIT.md (git log)
...
### 44. `f0b7446` — Fix wallet stale flicker, bot yellow mislead, ETH synthetic balance & cycle ledger fee bug
...
### 45. `ec8e100` — docs: sync GIT.md (git log)
...
### 46. `dabab68` — Speed up finance history first paint
...
### 47. `310fb3c` — docs: sync GIT.md (git log)
...
### 48. `1b1dc05` — Add bounded log maintenance and reduce runtime noise
...
### 49. `285d08e` — docs: sync GIT.md (git log)
...
### 50. `40264fc` — Stabilize dashboard runtime and UI state
...
### 51. `53479f6` — docs: sync GIT.md (git log)
...
### 52. `e060cae` — Improve admin, dashboard, and bot detail UX with perf and scroll fixes.
...
### 53. `f0519b1` — docs: sync GIT.md (git log)
...
### 54. `dfd42cc` — Expand login page with zip welcome layout and market dock.
...
### 55. `3f93c07` — docs: sync GIT.md (git log)
...
### 56. `44f08d8` — Redesign login page with zip AuthCard glass theme.
...
### 57. `c69193c` — docs: sync GIT.md (git log)
...
### 58. `5a99e35` — Fix Binance wallet errors, dashboard UX, and engine log stability.
...
### 59. `95318b1` — docs: sync GIT.md (git log)
...
### 60. `1e03319` — Fix dashboard connectivity, rate-limit toasts, and bot UX regressions.
...
### 61. `99aeb83` — docs: sync GIT.md (git log)
...
### 62. `e17f1da` — UI: redesign admin header/KPI/tabs and improve dashboard Bots persistence.
...
### 63. `4b8b710` — docs: sync GIT.md with Bots tab and wallet UX commit details.
...
### 64. `3f64a0a` — docs: sync GIT.md (git log)
...
### 65. `a8280fd` — Restore dashboard Bots tab and improve wallet/manager spot UX.
...
### 66. `a30acfa` — docs: sync GIT.md (git log)
...
### 67. `42444b9` — Perf: batch live API, bulk state loads, and calmer UI polling.
...
### 68. `5dc6e2c` — docs: sync GIT.md (git log)
...
### 69. `4857932` — UI stability, manager metrics, and test-account worker hardening.
...
### 70. `71e8888` — docs: sync GIT.md (git log)
...
### 71. `13b5770` — Improve test paper trading realism and align test KPIs across admin and dashboard.
...
### 72. `b2ab64c` — docs: sync GIT.md (git log)
...
### 73. `329f600` — Align admin active bot count and reduce Binance/asyncio log noise.
...
### 74. `385d3e9` — docs: sync GIT.md (git log)
...
### 75. `2a7894d` — Fix test account wallet KPI/strip and harden upstream error handling.
...
### 76. `7271b17` — docs: sync GIT.md (git log)
...
### 77. `dc69f29` — docs: sync GIT.md (git log)
...
### 78. `9ec9b4f` — Fix bot state hero panel live updates and duration ticker.
...
### 79. `eda020a` — docs: sync GIT.md (git log)
...
### 80. `419defa` — docs: sync GIT.md (git log)
...
### 81. `a09249b` — Fix manager global restart UnboundLocalError causing HTTP 500.
...
### 82. `19eea96` — docs: sync GIT.md (git log)
...
### 83. `1a87f0f` — docs: sync GIT.md (git log)
...
### 84. `5f6c321` — docs: sync GIT.md (git log)
...
### 85. `80e39e9` — Bot UI/engine reliability: daily K/Z, cycle timer, logs, and manager global actions.
...
### 86. `4245e01` — docs: sync GIT.md (git log)
...
### 87. `1db1ee5` — docs: sync GIT.md (git log)
...
### 88. `c2c6cae` — docs: sync GIT.md (git log)
...
### 89. `9987ecb` — docs: sync GIT.md (git log)
...
### 90. `379bb3c` — Bot session tenure, connectivity restore, synthetic cycle logs, and wallet KPI alignment.
...
### 91. `2498bb1` — Dashboard, manager, and engine hardening across bot perf, leaderboard, and ops.
...
### 92. `7756f7c` — docs: sync GIT.md (git log)
...
### 93. `5a163ba` — Bot health resilience, grid/profit UI polish, and engine hardening.
...
### 94. `9634309` — docs: sync GIT.md (git log)
...
### 95. `3531540` — Grid trailing, Binance connectivity, and dashboard KPI hardening.
...
### 96. `5481c74` — docs: sync GIT.md (git log)
...
### 97. `1974512` — Add grid trade modal, manager log UX, and bot detail sync fixes.
...
### 98. `1cd3a5e` — Update marketing submodule to latest landing and deploy changes.
...
### 99. `805594b` — Engine log UX, health alerts, grid trailing hardening, and tur trade fixes.
...
### 100. `4ba8f8c` — Checkpoint: pre profit-exit trigger fix (REST SSOT, UI, ops reorg).
...
### 101. `8c5aa65` — chore: history — 2026-05-06 öncesi tüm commitler squash edildi
