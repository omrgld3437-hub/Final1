...
> HEAD `796a807` · Toplam **90** commit · branch `main`
...
| Aktif branch | `main` |
| HEAD (kısa) | `796a807` |
| HEAD (tam) | `796a807dead6b08e494e21b010f80ae698ec043d` |
...
### 1. `796a807` — ci: stabilize github actions quality job
...
### 2. `e4bbdda` — docs: sync GIT.md (git log)
...
### 3. `d7e5bfa` — fix(test): test_parallel_grids max_buy_levels=2 eksikti
...
### 4. `a8543b2` — docs: sync GIT.md (git log)
...
### 5. `cf12ad3` — ci: ruff lint+format hatalarını düzelt, ruff.toml ekle
...
### 6. `c6d5f3a` — docs: sync GIT.md (git log)
...
### 7. `cfdec7a` — fix: bot detay start logları gizlenme hatası düzeltildi
...
### 8. `c008064` — docs: sync GIT.md (git log)
...
### 9. `e7c4678` — fix: user stream yeniden başlatma sonrası hatalı ERROR seviyesi giderildi
...
### 10. `63078d8` — docs: sync GIT.md (git log)
...
### 11. `409c88a` — fix: user stream HTML yanıt tespiti — ağ engeli ile API hatası ayırt edildi
...
### 12. `da9761f` — docs: sync GIT.md (git log)
...
### 13. `ad0df7d` — feat: kapsamlı UI/UX ve backend iyileştirmeleri
...
### 14. `a6d07e3` — docs: sync GIT.md (git log)
...
### 15. `11173e6` — Display enriched CYCLE_END/START fields in bot engine log UI
...
### 16. `223cfb3` — docs: sync GIT.md (git log)
...
### 17. `abca2df` — Enrich CYCLE_END/START events: duration, grid utilization, price range, breakeven, cumulative PnL
...
### 18. `637e93f` — docs: sync GIT.md (git log)
...
### 19. `b6cd00c` — Production hardening and bot health fixes
...
### 20. `59fbd9a` — docs: sync GIT.md (git log)
...
### 21. `95a498b` — Fix USER_STREAM 410 Gone: auto-reconnect + account label in logs
...
### 22. `d140169` — docs: sync GIT.md (git log)
...
### 23. `350bbdb` — Modularize dashboard.js phase 3: bot-perf, tx-history, bots, create-modal, tabs
...
### 24. `791ca71` — docs: sync GIT.md (git log)
...
### 25. `ccad8be` — Modularize dashboard.js phase 2: appbar, wallet-state, spot-trade, finance
...
### 26. `5c8dcee` — docs: sync GIT.md (git log)
...
### 27. `b9a042f` — Modularize dashboard.js: extract format utils + leaderboard (phase 1)
...
### 28. `e2d8fba` — docs: sync GIT.md (git log)
...
### 29. `2c6479f` — Implement CTO report items: CORS, admin security, daily loss limit, health endpoints
...
### 30. `98e58e9` — docs: sync GIT.md (git log)
...
### 31. `c05cad8` — Fix BINANCE_UNREACHABLE false-positive: suppress transient outage alerts & faster recovery
...
### 32. `c4aecf7` — docs: sync GIT.md (git log)
...
### 33. `f0b7446` — Fix wallet stale flicker, bot yellow mislead, ETH synthetic balance & cycle ledger fee bug
...
### 34. `ec8e100` — docs: sync GIT.md (git log)
...
### 35. `dabab68` — Speed up finance history first paint
...
### 36. `310fb3c` — docs: sync GIT.md (git log)
...
### 37. `1b1dc05` — Add bounded log maintenance and reduce runtime noise
...
### 38. `285d08e` — docs: sync GIT.md (git log)
...
### 39. `40264fc` — Stabilize dashboard runtime and UI state
...
### 40. `53479f6` — docs: sync GIT.md (git log)
...
### 41. `e060cae` — Improve admin, dashboard, and bot detail UX with perf and scroll fixes.
...
### 42. `f0519b1` — docs: sync GIT.md (git log)
...
### 43. `dfd42cc` — Expand login page with zip welcome layout and market dock.
...
### 44. `3f93c07` — docs: sync GIT.md (git log)
...
### 45. `44f08d8` — Redesign login page with zip AuthCard glass theme.
...
### 46. `c69193c` — docs: sync GIT.md (git log)
...
### 47. `5a99e35` — Fix Binance wallet errors, dashboard UX, and engine log stability.
...
### 48. `95318b1` — docs: sync GIT.md (git log)
...
### 49. `1e03319` — Fix dashboard connectivity, rate-limit toasts, and bot UX regressions.
...
### 50. `99aeb83` — docs: sync GIT.md (git log)
...
### 51. `e17f1da` — UI: redesign admin header/KPI/tabs and improve dashboard Bots persistence.
...
### 52. `4b8b710` — docs: sync GIT.md with Bots tab and wallet UX commit details.
...
### 53. `3f64a0a` — docs: sync GIT.md (git log)
...
### 54. `a8280fd` — Restore dashboard Bots tab and improve wallet/manager spot UX.
...
### 55. `a30acfa` — docs: sync GIT.md (git log)
...
### 56. `42444b9` — Perf: batch live API, bulk state loads, and calmer UI polling.
...
### 57. `5dc6e2c` — docs: sync GIT.md (git log)
...
### 58. `4857932` — UI stability, manager metrics, and test-account worker hardening.
...
### 59. `71e8888` — docs: sync GIT.md (git log)
...
### 60. `13b5770` — Improve test paper trading realism and align test KPIs across admin and dashboard.
...
### 61. `b2ab64c` — docs: sync GIT.md (git log)
...
### 62. `329f600` — Align admin active bot count and reduce Binance/asyncio log noise.
...
### 63. `385d3e9` — docs: sync GIT.md (git log)
...
### 64. `2a7894d` — Fix test account wallet KPI/strip and harden upstream error handling.
...
### 65. `7271b17` — docs: sync GIT.md (git log)
...
### 66. `dc69f29` — docs: sync GIT.md (git log)
...
### 67. `9ec9b4f` — Fix bot state hero panel live updates and duration ticker.
...
### 68. `eda020a` — docs: sync GIT.md (git log)
...
### 69. `419defa` — docs: sync GIT.md (git log)
...
### 70. `a09249b` — Fix manager global restart UnboundLocalError causing HTTP 500.
...
### 71. `19eea96` — docs: sync GIT.md (git log)
...
### 72. `1a87f0f` — docs: sync GIT.md (git log)
...
### 73. `5f6c321` — docs: sync GIT.md (git log)
...
### 74. `80e39e9` — Bot UI/engine reliability: daily K/Z, cycle timer, logs, and manager global actions.
...
### 75. `4245e01` — docs: sync GIT.md (git log)
...
### 76. `1db1ee5` — docs: sync GIT.md (git log)
...
### 77. `c2c6cae` — docs: sync GIT.md (git log)
...
### 78. `9987ecb` — docs: sync GIT.md (git log)
...
### 79. `379bb3c` — Bot session tenure, connectivity restore, synthetic cycle logs, and wallet KPI alignment.
...
### 80. `2498bb1` — Dashboard, manager, and engine hardening across bot perf, leaderboard, and ops.
...
### 81. `7756f7c` — docs: sync GIT.md (git log)
...
### 82. `5a163ba` — Bot health resilience, grid/profit UI polish, and engine hardening.
...
### 83. `9634309` — docs: sync GIT.md (git log)
...
### 84. `3531540` — Grid trailing, Binance connectivity, and dashboard KPI hardening.
...
### 85. `5481c74` — docs: sync GIT.md (git log)
...
### 86. `1974512` — Add grid trade modal, manager log UX, and bot detail sync fixes.
...
### 87. `1cd3a5e` — Update marketing submodule to latest landing and deploy changes.
...
### 88. `805594b` — Engine log UX, health alerts, grid trailing hardening, and tur trade fixes.
...
### 89. `4ba8f8c` — Checkpoint: pre profit-exit trigger fix (REST SSOT, UI, ops reorg).
...
### 90. `8c5aa65` — chore: history — 2026-05-06 öncesi tüm commitler squash edildi
