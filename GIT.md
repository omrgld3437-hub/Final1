...
> HEAD `0686ad5` · Toplam **237** commit · branch `main`
...
| Aktif branch | `main` |
| HEAD (kısa) | `0686ad5` |
| HEAD (tam) | `0686ad533c18ff1404aa7f65fcf64e3beff3a1ae` |
...
### 1. `0686ad5` — fix(test): test_parallel_grids max_buy_levels=2 eksikti

- **Commit no (tam):** `0686ad533c18ff1404aa7f65fcf64e3beff3a1ae`
- **Commit no (kısa):** `0686ad5`
...
### 2. `199eda6` — docs: sync GIT.md (git log)

- **Commit no (tam):** `199eda69530a0a09de8413071d502ea0aee6918a`
- **Commit no (kısa):** `199eda6`
- **Tarih:** 2026-06-06 04:47:55 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 3. `4302855` — ci: ruff lint+format hatalarını düzelt, ruff.toml ekle

- **Commit no (tam):** `430285571a8d2034100f15a46cc92a8278d15f3d`
- **Commit no (kısa):** `4302855`
- **Tarih:** 2026-06-06 04:47:55 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 4. `058d706` — docs: sync GIT.md (git log)

- **Commit no (tam):** `058d706c6849160eac8043190e683c1fa515dde5`
- **Commit no (kısa):** `058d706`
- **Tarih:** 2026-06-06 03:49:29 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 5. `318fc0b` — fix: bot detay start logları gizlenme hatası düzeltildi

- **Commit no (tam):** `318fc0b6768e7db9cde4a5dfb6c57d02d1a9422d`
- **Commit no (kısa):** `318fc0b`
- **Tarih:** 2026-06-06 03:49:29 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 6. `14db907` — docs: sync GIT.md (git log)

- **Commit no (tam):** `14db907a96baf9f39ba5d5408db5f81a8d25e102`
- **Commit no (kısa):** `14db907`
- **Tarih:** 2026-06-05 20:00:48 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 7. `1f93013` — fix: user stream yeniden başlatma sonrası hatalı ERROR seviyesi giderildi

- **Commit no (tam):** `1f93013ada64fa8d8dc657bc5291f043d0313539`
- **Commit no (kısa):** `1f93013`
- **Tarih:** 2026-06-05 20:00:48 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 8. `3422321` — docs: sync GIT.md (git log)

- **Commit no (tam):** `3422321d3ec72930844a478336ea64f2ed47c8f8`
- **Commit no (kısa):** `3422321`
- **Tarih:** 2026-06-05 19:50:34 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 9. `dadd9fc` — fix: user stream HTML yanıt tespiti — ağ engeli ile API hatası ayırt edildi

- **Commit no (tam):** `dadd9fc9b8d154c883c1e83425165f6ab0323369`
- **Commit no (kısa):** `dadd9fc`
- **Tarih:** 2026-06-05 19:50:34 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 10. `b812b9e` — docs: sync GIT.md (git log)

- **Commit no (tam):** `b812b9ea662ca1530b9774dd24dcb05ae4050d4d`
- **Commit no (kısa):** `b812b9e`
- **Tarih:** 2026-06-04 23:13:56 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 11. `222124e` — feat: kapsamlı UI/UX ve backend iyileştirmeleri

- **Commit no (tam):** `222124e75f9cfd9286d7a51b0f4b24d1d3df8221`
- **Commit no (kısa):** `222124e`
- **Tarih:** 2026-06-04 23:13:56 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
  - Bot & Performans:
...
### 12. `21ba7ad` — docs: sync GIT.md (git log)

- **Commit no (tam):** `21ba7adbaef83d4636fc2843c4a78f21e44825b8`
- **Commit no (kısa):** `21ba7ad`
- **Tarih:** 2026-06-04 11:56:54 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 13. `d796e70` — Display enriched CYCLE_END/START fields in bot engine log UI

- **Commit no (tam):** `d796e70c2938f496f50dc85999ed629abb39889a`
- **Commit no (kısa):** `d796e70`
- **Tarih:** 2026-06-04 11:56:54 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 14. `64e412a` — docs: sync GIT.md (git log)

- **Commit no (tam):** `64e412a226788074295d6f1a5881c8b691f26dd4`
- **Commit no (kısa):** `64e412a`
- **Tarih:** 2026-06-04 11:48:07 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 15. `0abf741` — Enrich CYCLE_END/START events: duration, grid utilization, price range, breakeven, cumulative PnL

- **Commit no (tam):** `0abf7417c0792dda4a0e96f40c015e565e134e6b`
- **Commit no (kısa):** `0abf741`
- **Tarih:** 2026-06-04 11:48:07 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 16. `4d4f417` — docs: sync GIT.md (git log)

- **Commit no (tam):** `4d4f417c044e379573200bc8efe4f98ea989631e`
- **Commit no (kısa):** `4d4f417`
- **Tarih:** 2026-06-04 11:31:04 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 17. `869b4bc` — Production hardening and bot health fixes

- **Commit no (tam):** `869b4bc84e8feeaec2eedd135a54ef0742e6a90e`
- **Commit no (kısa):** `869b4bc`
- **Tarih:** 2026-06-04 11:31:04 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 18. `3b15063` — docs: sync GIT.md (git log)

- **Commit no (tam):** `3b15063525c9295831e9b0f05f0aa4cd5f17a3a3`
- **Commit no (kısa):** `3b15063`
- **Tarih:** 2026-06-04 11:13:11 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 19. `1580b25` — Fix USER_STREAM 410 Gone: auto-reconnect + account label in logs

- **Commit no (tam):** `1580b256718190e2bd2dbd5ad6290dca0a25b236`
- **Commit no (kısa):** `1580b25`
- **Tarih:** 2026-06-04 11:13:11 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
  - 410 Gone root cause:
...
### 20. `a6c1c0a` — docs: sync GIT.md (git log)

- **Commit no (tam):** `a6c1c0a415cc6a3671bf1636c75d839e22ba8e56`
- **Commit no (kısa):** `a6c1c0a`
- **Tarih:** 2026-06-04 03:04:02 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 21. `c2b777a` — Modularize dashboard.js phase 3: bot-perf, tx-history, bots, create-modal, tabs

- **Commit no (tam):** `c2b777a10884bf719f8f75bc6e65665a398c107b`
- **Commit no (kısa):** `c2b777a`
- **Tarih:** 2026-06-04 03:04:02 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 22. `dbc5d9d` — docs: sync GIT.md (git log)

- **Commit no (tam):** `dbc5d9dc0ec7cd7bcb50435f9ba83512eb6f8cd3`
- **Commit no (kısa):** `dbc5d9d`
- **Tarih:** 2026-06-04 02:49:01 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 23. `1c609e8` — Modularize dashboard.js phase 2: appbar, wallet-state, spot-trade, finance

- **Commit no (tam):** `1c609e8bccee89d4122ace1860705c6b75636318`
- **Commit no (kısa):** `1c609e8`
- **Tarih:** 2026-06-04 02:49:01 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 24. `43481a5` — docs: sync GIT.md (git log)

- **Commit no (tam):** `43481a5f09d9bbf2178d174a02ad2b2a45e3e040`
- **Commit no (kısa):** `43481a5`
- **Tarih:** 2026-06-04 02:37:03 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 25. `a0f71b9` — Modularize dashboard.js: extract format utils + leaderboard (phase 1)

- **Commit no (tam):** `a0f71b900fc811b206c056e57820457d11912a6d`
- **Commit no (kısa):** `a0f71b9`
- **Tarih:** 2026-06-04 02:37:03 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>
- **Detay:**
...
### 26. `7bdf56b` — docs: sync GIT.md (git log)

- **Commit no (tam):** `7bdf56b9893d47c876b02abe5418fe83169c17d4`
- **Commit no (kısa):** `7bdf56b`
- **Tarih:** 2026-06-03 21:36:06 +0300
- **Yazar:** Ömer Altın <omeraltin@192.168.1.25>

---

### 27. `f932464` — Implement CTO report items: CORS, admin security, daily loss limit, health endpoints
...
### 28. `d1dae1d` — docs: sync GIT.md (git log)
...
### 29. `777335c` — Fix BINANCE_UNREACHABLE false-positive: suppress transient outage alerts & faster recovery
...
### 30. `375f01e` — docs: sync GIT.md (git log)
...
### 31. `7858715` — Fix wallet stale flicker, bot yellow mislead, ETH synthetic balance & cycle ledger fee bug
...
### 32. `83e9281` — docs: sync GIT.md (git log)
...
### 33. `25383a3` — Speed up finance history first paint
...
### 34. `7f1fde1` — docs: sync GIT.md (git log)
...
### 35. `f9a88b1` — Add bounded log maintenance and reduce runtime noise
...
### 36. `f0f5704` — docs: sync GIT.md (git log)
...
### 37. `f838887` — Stabilize dashboard runtime and UI state
...
### 38. `a4f7bdf` — docs: sync GIT.md (git log)
...
### 39. `28bd1cb` — Improve admin, dashboard, and bot detail UX with perf and scroll fixes.
...
### 40. `16f4b0e` — docs: sync GIT.md (git log)
...
### 41. `40d94b5` — Expand login page with zip welcome layout and market dock.
...
### 42. `3233273` — docs: sync GIT.md (git log)
...
### 43. `49894a6` — Redesign login page with zip AuthCard glass theme.
...
### 44. `f0f5f39` — docs: sync GIT.md (git log)
...
### 45. `20f5dea` — Fix Binance wallet errors, dashboard UX, and engine log stability.
...
### 46. `9e2975d` — docs: sync GIT.md (git log)
...
### 47. `8cc402b` — Fix dashboard connectivity, rate-limit toasts, and bot UX regressions.
...
### 48. `25b1172` — docs: sync GIT.md (git log)
...
### 49. `8bda11c` — UI: redesign admin header/KPI/tabs and improve dashboard Bots persistence.
...
### 50. `24b8cbd` — docs: sync GIT.md with Bots tab and wallet UX commit details.
...
### 51. `7d8dec2` — docs: sync GIT.md (git log)
...
### 52. `4a0c8c0` — Restore dashboard Bots tab and improve wallet/manager spot UX.
...
### 53. `d1e1413` — docs: sync GIT.md (git log)
...
### 54. `6101503` — Perf: batch live API, bulk state loads, and calmer UI polling.
...
### 55. `b222a55` — docs: sync GIT.md (git log)
...
### 56. `c47d391` — UI stability, manager metrics, and test-account worker hardening.
...
### 57. `5ba06fe` — docs: sync GIT.md (git log)
...
### 58. `7b8d1d2` — Improve test paper trading realism and align test KPIs across admin and dashboard.
...
### 59. `2b6259e` — docs: sync GIT.md (git log)
...
### 60. `5c4268f` — Align admin active bot count and reduce Binance/asyncio log noise.
...
### 61. `64e9548` — docs: sync GIT.md (git log)
...
### 62. `c9eb79d` — Fix test account wallet KPI/strip and harden upstream error handling.
...
### 63. `d0e5d36` — docs: sync GIT.md (git log)
...
### 64. `40f92bc` — docs: sync GIT.md (git log)
...
### 65. `80d8055` — Fix bot state hero panel live updates and duration ticker.
...
### 66. `b58ec63` — docs: sync GIT.md (git log)
...
### 67. `130f23e` — docs: sync GIT.md (git log)
...
### 68. `26f244c` — Fix manager global restart UnboundLocalError causing HTTP 500.
...
### 69. `45762b5` — docs: sync GIT.md (git log)
...
### 70. `c9ed330` — docs: sync GIT.md (git log)
...
### 71. `5ce1931` — docs: sync GIT.md (git log)
...
### 72. `7731660` — Bot UI/engine reliability: daily K/Z, cycle timer, logs, and manager global actions.
...
### 73. `6efd6f2` — docs: sync GIT.md (git log)
...
### 74. `e7ab403` — docs: sync GIT.md (git log)
...
### 75. `8a32511` — docs: sync GIT.md (git log)
...
### 76. `17c7138` — docs: sync GIT.md (git log)
...
### 77. `6efb1c5` — Bot session tenure, connectivity restore, synthetic cycle logs, and wallet KPI alignment.
...
### 78. `4af6274` — Dashboard, manager, and engine hardening across bot perf, leaderboard, and ops.
...
### 79. `d19ed58` — docs: sync GIT.md (git log)
...
### 80. `21db228` — Bot health resilience, grid/profit UI polish, and engine hardening.
...
### 81. `2a5dcd3` — docs: sync GIT.md (git log)
...
### 82. `6066d76` — Grid trailing, Binance connectivity, and dashboard KPI hardening.
...
### 83. `06cef9a` — docs: sync GIT.md (git log)
...
### 84. `901f1a3` — Add grid trade modal, manager log UX, and bot detail sync fixes.
...
### 85. `9cd5850` — Update marketing submodule to latest landing and deploy changes.
...
### 86. `f2b5379` — Engine log UX, health alerts, grid trailing hardening, and tur trade fixes.
...
### 87. `a699226` — Checkpoint: pre profit-exit trigger fix (REST SSOT, UI, ops reorg).
...
### 88. `f203968` — Sunucu deploy.sh: guncel commit ciktida, degisti ise belirtilir
...
### 89. `f9fcf9b` — Linux HTML başlatma, bakiye doğrulama, dual PNL (Cash/Inventory), perfPanel+tradesPanel, Aktif Emirler sadece Anasayfa
...
### 90. `2fea40c` — Admin: askı cache invalidation + çevrimiçi last_seen 2dk; sohbet flicker/typing düzeltmesi; coin logo cache 31 gün
...
### 91. `da82dd3` — Sohbet: admin yazıyor göstergesi + kullanıcı çevrimiçi/çevrimdışı nokta (yeşil/kırmızı)
...
### 92. `8fa1d4a` — Sohbet: anında mesaj (admin poll 2.5s, kullanıcı poll 2.5s, gönderim sonrası yenileme, welcome 1.2s)
...
### 93. `4a93a08` — Login: kripto logo flicker onleme - liste bir kez render, sonra sadece fiyat/chg guncelle
...
### 94. `c82c2d7` — Aktif Emirler paneli: emir yokken her zaman İşlem Geçmişi altında (txPanel.after)
...
### 95. `37791ce` — Admin: sunucu paneli, audit, hata logları, API rehberi
...
### 96. `a411a4b` — fix: logo flicker, price blink, bot performance period update; suppress ProactorBasePipeTransport log
...
### 97. `535a648` — omeraltin.com kapanma: HTML watchdog + auto_start + start.py sertlestirme
...
### 98. `ae3d5d3` — Admin tabs: mobile Sekmeler fix + perf (store, preload, instant switch)
...
### 99. `801d68d` — Bot sayfası: Başlat kaldırıldı; 401'de Hata (API anahtarı) gösterimi; strip fiyat/24h/mini grafik layout kayması düzeltmesi
...
### 100. `b2717f2` — Manager: GET / redirect, 401/ConnectionResetError log bastırma; Oluştur=anında başlat; Başlat butonu sadece stopped; Leaderboard parametreleri görüntüle + modal
...
### 101. `ef90350` — Bot 401: pause bot on Binance Unauthorized, set API_UNAUTHORIZED and ERROR event for UI
...
### 102. `9a1b6f8` — UI/UX: flicker fixes, mobile padding, admin tabs, leaderboard, chat; deploy nginx config
...
### 103. `d0c1f26` — Deploy: Nginx domain eski gorunum notu (DEPLOY.md) + show-nginx-config.bat (Windows)
...
### 104. `89cf45b` — start.bat: teshis ciktisi - Dashboard (diskte) surum + build-info URL + eski gorunum notu
...
### 105. `e81ea4f` — build-info login fix + no-cache UI: path normalize, route ilk sırada, no-cache middleware, DEPLOY notları
...
### 106. `e8cd6f8` — api/debug/build-info: lockdown whitelist'e ekle (giriş olmadan erişilebilsin)
...
### 107. `61248cf` — Deploy: Değişiklikler yansımıyor rehberi + /api/debug/build-info endpoint
...
### 108. `f5fb145` — Bot engine, routes, cycle_ledger, dashboard snapshot, UI: tüm kalan değişiklikler
...
### 109. `a3b8688` — Leaderboard: sadece kârda botlar; Bulunamadı mesajı. Admin: sarı çerçeve, tab sarı+kayma, koyu tema, hover glow
...
### 110. `9153e39` — Admin: tab slider indicator + içerik kayma animasyonu
...
### 111. `cd4e83d` — Copy Trading + Global Leaderboard; admin hesap kartları stil
...
### 112. `4598ac0` — Spot modal: hemen açılma + yüzde flicker düzeltmesi; ilk giriş popup sırası + mobil X
...
### 113. `c170a91` — binance_spot: _binance_ip_ban global kaldırıldı – mutable state ile 'used prior to global declaration' hatası giderildi
...
### 114. `7a0817a` — Wallet: bot/emir kilitli strip+tablo; Trade favori: sembol/fiyat tam görünsün
...
### 115. `0698e05` — Dashboard, bot panel, popup, perf: İşlem geçmişi görünürlük, fiyat blink, live K/Z, popup etiket, SLOW_REQUEST optimizasyonu
...
### 116. `e210bf5` — Dashboard & API: perf, UX, işlem geçmişi, yenilemede sekme koruma
...
### 117. `64fb33e` — ui: dashboard trade view + wallet refresh + bot detail back link
...
### 118. `c1012b3` — fix: bot running but no real Binance trades — run_id, reconcile NOT_FOUND, verify-before-repair
...
### 119. `3dfdd54` — feat: BOT_TICK_SUMMARY + BOT_TEŞHIS_DUMP on loop start; favori coin layout fix
...
### 120. `7f879df` — fix: live/paper audit logs, Bot Performansı %, Favori Coinler, İşlem Geçmişi paneli, manager favicon/alerts
...
### 121. `218a086` — fix: avoid logout on 401 UNAUTHORIZED (missing_token); only SESSION_NOT_FOUND triggers session invalid; auth missing_token log at DEBUG
...
### 122. `ca855ba` — fix: force mainnet for non-test accounts; log BOT_ACCOUNT_CTX (paper_mode, testnet) at tick start
...
### 123. `1cdf887` — fix: sync virtual_wallet from state when initial_allocation_done so balance not overwritten; repair log
...
### 124. `113c237` — fix: real account never runs in paper mode (paper only when test user and no API keys)
...
### 125. `d40a24e` — fix: repair set initial_allocation_done to stop repeat repair; data_hub get_all_prices snapshot
...
### 126. `edb7864` — fix: initial allocation repair use intent client_order_id; dashboard bot performance range flicker
...
### 127. `7891d83` — feat: pre-fill bot create form with last used params (localStorage)
...
### 128. `84ec6d2` — fix: initial allocation 1s retry; v5 use strategy next_wake; remove Performans raporu block; spec
...
### 129. `af57288` — fix: restore Favori Coinler layout to previous working state (inline list style, simpler mobile CSS)
...
### 130. `c6a7d68` — fix: bot detail live price + initial allocation state UX
...
### 131. `d2741b4` — fix: bots_delete skip convert on worker-only error, proceed with delete
...
### 132. `1b0bb33` — fix: remove redundant local import of update_intent_filled to fix UnboundLocalError
...
### 133. `e3bb759` — fix: chart page mobile – flex layout, 44px touch targets, no horizontal overflow
...
### 134. `3b6989a` — fix: Bot Create modal mobile – viewport lock, body-only scroll, form spacing
...
### 135. `d2719ec` — perf & UI: finance/trades 365d cap; snapshot 5s; bot perf flicker fix; tx history order grouping + Binance platform + layout; mobile trade favs & Bot Create modal
...
### 136. `6c5dd19` — fix: spot order HTTPException re-raise (no 500); mobile trade fav layout 30/50px from logo
...
### 137. `2bfb377` — Trade favorileri: sembol logonun yanında, fiyat 30 boşluk, yüzde 50 boşluk hizalama
...
### 138. `7dc4458` — fix: Bot Performansı PnL flicker – sadece değer değişince DOM güncelle
...
### 139. `e8cb0a2` — Dashboard: Trade favorileri mobil sığdırma, sembol/logo hizalama, 30 boşluk spacer
...
### 140. `cf33970` — fix: bootstrap 404, mobile wallet, spot order from web, ticker desktop-only
...
### 141. `29335ec` — fix(mobile): wallet data on mobile — sync bootstrap wallet from dashboardStore to assetsState
...
### 142. `fd2b91d` — fix(mobile): hide top ticker strip; ensure Binance data loads on mobile
...
### 143. `eee7bea` — fix: snapshot cache-only wallet + dashboard bootstrap + mobile ticker hide
...
### 144. `51ba364` — mobile: root fix - tabs + prices visible
...
### 145. `e11dfec` — fix: SyntaxError in api_debug_wallet_diag snapshot_asset_count
...
### 146. `6ef26df` — wallet: CURSOR TASK - normalizeAndApplyWallet, debug overlay, trace logs, diag endpoint
...
### 147. `e6f75cc` — fix: Wallet loading / cüzdan hiç gelmiyor — 5 patch uygulandı
...
### 148. `43b775a` — fix: dashboard flicker, wallet loading, appbar mobile, manager Windows Server
...
### 149. `cb7fdc9` — fix: Flash Home fallback + mobile Trade favori/arama
...
### 150. `1b22c82` — fix(ui): preserve last good spot balance in Flash Home walletCachedToAssetsState
...
### 151. `caab28d` — fix: Binance wallet flash to 0 + mobile appbar center width
...
### 152. `3976ba6` — fix(ui): mobile dashboard appbar single-row layout and alignment
...
### 153. `51c93ef` — Binance: 429 reduce myTrades to 40 symbols + delay + cooldown 10min; 401/timeout: 8s timeout, timestamp fallback, wallet_error in snapshot
...
### 154. `048c42f` — start.bat: checkout stop.bat before pull to avoid merge abort; note for file-in-use error
...
### 155. `3718194` — Manager: global actions include HTML, restart(html), loading state and feedback for all buttons; stop.bat and DEPLOY notes
...
### 156. `08d71d1` — Add app.services.dashboard_snapshot to repo; 503 on snapshot when module missing
...
### 157. `25fa288` — fix(stop.bat): port-based kill first, locale-safe netstat, run-as-admin hint
...
### 158. `01a9542` — docs: add app.api.utils to ModuleNotFoundError section in DEPLOY.md
...
### 159. `4de2f98` — Add app.api.utils (fields) for snapshot; defensive import in routes (fallback if module missing)
...
### 160. `00e4eab` — Server: middleware optional (app.middleware yoksa baslar), middleware repoya, worker DataHub warmup, deploy CRASH_LOOP notu
...
### 161. `b65acc8` — deploy: ModuleNotFoundError (app.core / intent_ledger) icin git pull ve manuel kopya notu
...
### 162. `766165d` — Add app.core module (auth.token_utils, config, constants, errors, security) for server - fix ModuleNotFoundError: app.core
...
### 163. `bc08bf0` — Windows: uvloop/httptools atlama (ModuleNotFoundError on server)
...
### 164. `354b34d` — Add missing botengine modules (intent_ledger, kill_switch, reconcile, scheduler, bot_run, errors, user_stream) for server deploy
...
### 165. `d7a979c` — UI: popup 405 fix, Görüntüleyen+UTC+3, auth log, appbar sticky, login telefon label/placeholder, dm-tabs sola
...
### 166. `0a724da` — UI: çıkış butonu ortala/KPI hiza, popup detay+okuyanlar, Ayarlar sekmesi sağa
...
### 167. `1bcc836` — fix(auth): do not logout on boot_id change; validate via whoami
...
### 168. `5bda1f6` — fix: perf chart modal crosshair guard (pt + try/catch), cache bust v=2
...
### 169. `46e3874` — Login-forex paralel; rebalancing USDT satiri; finance trades 90s timeout + cache bust; perf_chart crosshair param guard
...
### 170. `af74323` — Login-forex: altin yedek Binance PAXGUSDT; Manager: web durumu port 8000 ile
...
### 171. `248d1a2` — Login: döviz/altin backend /api/login-forex proxy (CORS cozumu)
...
### 172. `8686cb2` — 503 hata mesaji: backend detail.message goster (BINANCE_MASTER_KEY uyarisi)
...
### 173. `41ff1ef` — Login: kripto fiyatlari backend /api/login-crypto uzerinden (CORS cozumu)
...
### 174. `5da991d` — Admin panel: giris yapan adminin kendi hesabi tile listesinde gosterilmesin
...
### 175. `9b8ee7e` — Login: ilk admin sentinel bcrypt kaldirildi (Invalid salt hatasi duzeltildi)
...
### 176. `b83fce6` — İlk admin otomatik, varsayılan şifre kaldırıldı; ilk girişte yazılan şifre kalıcı. Kullanıcı yoksa 'Kullanıcı bulunamadı' mesajı.
...
### 177. `7c6c910` — create_first_admin.py: ilk admin yoksa olusturur (Admin / Omeromer01.)
...
### 178. `1c595b3` — Login 401: localhostta debug_hint (user_not_found / invalid_password) ve arayuzde gosterim
...
### 179. `58e28a4` — Giris: sifre dogrulama NFC + NFD + raw strip ile tam uyumluluk
...
### 180. `40174e9` — Silinen dosyalar: SEO_MASTER_*, calistir.bat
...
### 181. `15efe04` — Admin varsayilan sifre Omeromer01., giris sonrasi yeni sifre zorunlu
...
### 182. `6b9b6c3` — guncelle.bat mesaji; deploy_windows.sh Windows sunucu deploy
...
### 183. `0b57ef0` — Admin sifresi giris yapmadan sifirlama: ADMIN_PASSWORD_RESET_SECRET ile endpoint
...
### 184. `584f60e` — Admin: telefon ile sifre atama endpointi (yayinda giris icin sifre senkron)
...
### 185. `efc00af` — Giris: sifre NFC/NFD normalizasyonu - local ve yayinda ayni sifre kabulu, invalid password log
...
### 186. `1b99ed6` — guncelle.bat: sunucuda start.bat eski kaldiginda once calistirilacak proje guncelleme scripti
...
### 187. `8bf6d31` — Giris: sifre dogrulama guclendirildi, trim ve hash str/bytes destegi
...
### 188. `b05f62e` — start.bat: batch echo duzeltmeleri, calistir kelimesi stir hatasini onlemek icin baslat ile degistirildi
...
### 189. `25e105e` — start.bat: git pull ciktisi goster; Omeraltinhtml yoksa yonlendirme mesaji
...
### 190. `044e331` — start.bat: guncel commit goster; Omeraltinhtml klasorunu adinda omeraltin gecen her varyanttan bul
...
### 191. `be4f246` — start/restart.bat: her calistirmada git pull; Omeraltinhtml klasor adi kontrolu
...
### 192. `a388351` — Login: şifre butonu yayında tutarlı, login.css v=2 cache-bust
...
### 193. `455adb7` — Şifre göster/gizle butonu: göz ikonu ve düzenli stil
...
### 195. `e529605` — init: project source
...
### 196. `fe8c9cf` — chore: prepare repo for deploy (ignore runtime/data)
...
### 198. `3e6fcbc` — chore: prepare project for git-based deploy (no logic changes)
...
### 199. `78acfea` — TRDCA bakiye düzeltmesi, login mobil scroll, favori coinler daraltma
...
### 200. `23d2d4e` — Kurulum: ilk calistirmada otomatik Kurulum.bat. start.bat: 8080/Omeraltinhtml terminal mesajlari. Kadran: tek renk koyu yesil + kucuk sik balik sirti efekti
...
### 201. `2a2cc3e` — Login: sözleşme onayları, modal scroll, Geri/Okudum anladım. stop/start/restart.bat düzeltmeleri, deploy ve command klasörleri
...
### 202. `c871840` — Admin: tema, mobil sekmeler, sunucu paneli, ticker gizleme, sekme hatırlama
...
### 203. `c2b240e` — Login: çıkış uyarısı kutu içinde kısa, Güvenli çıkış yapıldı, mobil Sekmeler dropdown sayfa içinde
...
### 204. `2618660` — Login: topbar bayrak sağda/buton boyu, kayan yıldız düz, mobil tab 50/50, modal sekmeler ortala
...
### 205. `e7b6395` — Login: saatler koyu Rolex yeşili ve zengin görünüm, nebula sağda sabit ve görünür
...
### 206. `b1dc19c` — Admin panel mobil: sekme dropdown hesapların üstünde görünsün (z-index düzeltmesi)
...
### 207. `86882a5` — feat: MULTI bot Sonlandır ve Sil - tüm coinleri quote'a çevir, modal metni güncelle
...
### 208. `e8ccbd7` — Start/stop sadece final1 kokunde: start.bat, stop.bat, restart.bat + .command; diger tum start/stop dosyalari kaldirildi
...
### 209. `e823e3c` — Manager panel: özet flicker düzeltmesi, WS errors_ring/warns_ring birleştirme, Hata/Uyarı panel etiketleri, 401 throttle özet satırı
...
### 210. `501052e` — Hata logları sıfırlama: backend clear endpoint + frontend entegrasyonu (yenileyince kalıcı temiz)
...
### 211. `2bebb02` — TRDCA Pro+ parametre ekranı, test hesabı iyileştirmeleri, hata logları ve UI düzeltmeleri
...
### 212. `041c4ff` — Test hesabı (test_local): sadece localhost giriş, paper mod, 10.000 USDT sanal bakiye
...
### 213. `3d4e9ee` — TRDCA Pro+ strateji entegrasyonu: backend (strategy_tick, apply_fills, DCA/TRB), orchestrator snapshot, execution batch, UI parametre ve detay sayfası
...
### 214. `2dff087` — Mobil uyumluluk, admin/error-logs API, Windows launcher ve genel güncellemeler
...
### 215. `4f745c1` — Manager panel (7999): hız, restart, log ve overview iyileştirmeleri
...
### 216. `dcb5cd9` — logs: .meta yeşil metin, #panelAnasistem dış çerçeve cırtlak pembe
...
### 217. `184d766` — Rebalancing entegrasyonu, UI/API düzeltmeleri, Binance saat senkronu
...
### 218. `0951fa5` — Log sunucusu düzeltmeleri: Python 3.9 uyumu (Optional[int]), Server Start'ta terminalde log, Yeniden Başlat sonrası poll+Sayfayı yenile, Anasistem sunucu istekleri
...
### 219. `907e638` — Worker sekmesi Toplam istek canlı güncelleme: worker_main sayacı, local_logs fallback, manager okuma sırası
...
### 220. `eb3c400` — Değişiklikler kaydedildi: Server Start, local_logs, orchestrator, worker_main, local_web_worker_helper, manager_backend, logs
...
### 221. `8fe922a` — Log sınıflandırma düzeltmesi: INFO/WARNING yanlış hata sayılması engellendi
...
### 222. `e9d5f2a` — Proje güncellemesi: Server Start/Stop, loglar sayfası (7999), web/worker ayrı yönetim, Sıfırla/401/renklendirme düzeltmeleri
...
### 223. `fb7a619` — feat: günlük PnL bot silindiğinde sıfırlanmasın — account_daily_realized_pnl cache
...
### 224. `fe407f5` — Clean cycle boundaries + compounding + perf chart + SELL balance guard
...
### 225. `f17a949` — Cycle PnL fix (fee-aware), perf chart, XRAY doc
...
### 226. `0d41fe9` — Grafik 1m/5m penceresi, canlı uç setData, tur/trades canlı güncelleme, işlem satırına gerçekleşme %, reference_price düzeltmesi
...
### 227. `206a309` — Güvenlik: breach shutdown + hesap askıya alma uyarısı; grid tamamlanınca tepe/dip/gerçekleşme dondurma; fill fiyatı 4 ondalık; fill fiyatı state ile grid UI
...
### 228. `b5a5e57` — Grafik: sunucuda state, yeni tarayıcıda yükleme, sekme kapalıyken kayıt
...
### 229. `287db18` — UI: Genel buton/perfGenelValue, işlemler yenileme, filtre-tablo boşlukları
...
### 230. `037f675` — UI: grafik yüzdeleri, grid/kar panelleri, cycle report, header/state sırası, bot tipi başlık, refD hatası
...
### 231. `aa21968` — Sonlandır/sil: base→quote seçilince Binance market satış; grafik bot bazlı clearForBot + başlatınca sıfırla
...
### 232. `6f13e74` — Paper→live zorunlu, initial allocation sıfırlama, ortalama maliyet execution_price, grafik bot bazlı, form varsayılanları
...
### 233. `73e411b` — Performans grafiği (Lightweight Charts), bot başlangıç/duration, cycle raporu, PNL/kar satışı, hata log API, grafik Sıfırla kaldırıldı
...
### 234. `ef44e08` — UI: cycle trades labels, symbol chart modal back fix, perf chart debug doc
...
### 235. `0e1e645` — Dashboard & bot: KPI bot bakiyesi, günlük PnL (tur kârı), işlemler sync, Toplam K/Z, performans grafiği
...
### 236. `6fa4eae` — Dashboard & bot: KPI günlük ref, işlemler TR saati, grid qty_pct, PNL kartı, blink, buton stilleri
...
### 237. `397ead6` — Performans raporu canlı veri, grid referans düzeltmesi, Bot Logları, bileşik tur
